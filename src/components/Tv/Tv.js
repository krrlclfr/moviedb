...
function Movie() {
    ...
    const getMovie = async() => {
        const temp = await fetch(LINK + '/tv/' + params.id + '?api_key=' + API_KEY)
                    ...
                    <div className='col-span-3 h-screen w-full overflow-y-auto md:mt-8'>
                        <div className='md:mr-1'>
                            <div className=' md:h-1/2'>
                                    <div className='h-[50vh] bg-slate-900/50 md:h-1/2'>
                                    ...
                                    <div className='mt-[-70px] flex justify-center items-center '>
                                        <div className = "grid grid-cols-1 md:grid-cols-2 place-items-center bg-slate-50 rounded-md">
                                            <img src = {IMAGE + movie.poster_path} className = "z-10 h-full w-60  object-cover  " />
                                            ...
                                            <div className='w-60 pb-5 h-full text-black  flex justify-center items-center'>
                                                <div className=''>
                                                    ...
                                                    <div className='flex justify-center items-center text-center py-1'>
                                                        <h1 className = "text-xs"> {movie.first_air_date} </h1>
                                                    </div>
                                                    <div className='flex justify-center items-center text-center py-1'>
                                                        <h1 className = "text-xs"> {movie.type} </h1>
                                                    </div>
                                                    <div className='flex justify-center items-center text-center py-1'>
